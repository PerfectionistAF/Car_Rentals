...
@section('title', 'Add Post') 
    ...
    <form method="post" action="{{route('posts-store')}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
        ...
        <div class="item form-group">                                
            ...
            <div class="col-md-6 col-sm-6 ">
                <input type="text" name="post_title" required="required" class="form-control">
            </div>
        </div>    
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                <textarea name="post_content" id="" cols="30" rows="10" required="required" class="form-control">
                </textarea><!--<input type="text" name="post_content">-->
            </div>
        </div>
