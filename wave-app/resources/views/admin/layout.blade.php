        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-users"></i> Users <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('users.html')}}">Users List</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="{{route('loginform')}}">
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <a class="dropdown-item"  href="javascript:;">Help</a>
                        ...
                        <!--<i class="fa fa-sign-out pull-right"></i> action="{{ route('logout') }}" method="POST"-->
                        <a class="dropdown-item"  href="{{route('loginform')}}"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
