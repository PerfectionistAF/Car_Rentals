        ...
        <main class="tm-main">
          <div id="drink" class="tm-page-content">
            ...
            <nav class="tm-black-bg tm-drinks-nav">
              <ul>
                ...
                <li>
                  <a href="{{asset('#')}}" class="tm-tab-link" data-id="hot">Hot Coffee</a>
                </li>
                <li>
                  <a href="{{asset('#')}}" class="tm-tab-link" data-id="juice">Fruit Juice</a>
                </li>
              </ul>
            </nav>
            ...
            <div id="cold" class="tm-tab-content">
              <div class="tm-list">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/iced-cappuccino.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/iced-espresso.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/iced-latte.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Iced Latte<span class="tm-list-item-price">$11.50</span></h3>
                    <p class="tm-list-item-description">Contents are organized into 3 tabs. Please <a href="{{asset('https://www.tooplate.com/contact')}}" rel="nofollow" target="_parent">contact Tooplate</a> if you have anything to ask.</p>
                  </div>
                </div> 
            ...
            <div id="hot" class="tm-tab-content">
              <div class="tm-list">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/hot-americano.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/hot-cappuccino.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/hot-espresso.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/hot-latte.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
            ...
            <div id="juice" class="tm-tab-content">
              <div class="tm-list">
                <div class="tm-list-item">          
                  <img src="{{asset('img/smoothie-1.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/smoothie-2.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/smoothie-3.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">          
                  <img src="{{asset('img/smoothie-4.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
          ...
          <div id="about" class="tm-page-content">
            ...
            <div class="tm-black-bg tm-mb-20 tm-about-box-2">              
              <div class="tm-list-item tm-list-item-2">                
                ...
                <img src="{{asset('img/about-2.png')}}" alt="Image" class="tm-list-item-img tm-list-item-img-big tm-img-right">                
              </div>
          ...
          <div id="special" class="tm-page-content">
            <div class="tm-special-items">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('img/special-02.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('img/special-03.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('img/special-04.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('img/special-05.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('img/special-06.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
